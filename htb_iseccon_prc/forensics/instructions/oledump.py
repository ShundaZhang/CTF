...
Using #s#demo will instruct oledump to generate a rule to search for string demo (rule string {strings: a="demo"asciiwidenocasecondition:a) and use that rule.
...
def YARACompile(ruledata):
    if ruledata.startswith('#'):
        if ruledata.startswith('#h#'):
            ...
            rule = 'rule string {strings: a="a}' % ruledata[3:]
            ...
            rule = 'rule regex {strings: a=/a}' % ruledata[3:]
        else:
            rule = ruledata[1:]
