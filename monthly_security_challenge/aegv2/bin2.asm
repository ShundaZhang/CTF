...
aegv2:     file format elf64-x86-64
...
00000000004020a9 <vuln>:
  ...
  4020b1:	48 81 ec c0 00 00 00 	sub    $0xc0,%rsp
  4020b8:	c7 45 fc 70 dc 95 2b 	movl   $0x2b95dc70,-0x4(%rbp)
  4020bf:	48 8d 85 40 ff ff ff 	lea    -0xc0(%rbp),%rax
  4020c6:	ba 88 02 00 00       	mov    $0x288,%edx
  4020cb:	48 89 c6             	mov    %rax,%rsi
  4020ce:	bf 00 00 00 00       	mov    $0x0,%edi
  4020d3:	e8 68 0c 00 00       	call   402d40 <read>
  4020d8:	b8 70 dc 95 2b       	mov    $0x2b95dc70,%eax
...
000000000040a000 <puzzle_x86_64>:
  40a000:	4c b0 a1             	rex.WR mov $0xa1,%al
  40a003:	45 ea                	rex.RB (bad) 
  40a005:	f7 36                	divl   (%rsi)
  40a007:	5a                   	pop    %rdx
  40a008:	36 c2 43 34          	ss ret $0x3443
  40a00c:	fa                   	cli    
  40a00d:	43 9a                	rex.XB (bad) 
  40a00f:	bf b7 bf bf 3a       	mov    $0x3abfbfb7,%edi
  40a014:	7f ca                	jg     409fe0 <_fini+0xbec>
  40a016:	b5 07                	mov    $0x7,%ch
  40a018:	bf bf bf bf 56       	mov    $0x56bfbfbf,%edi
  40a01d:	38 bd bf bf 34 fa    	cmp    %bh,-0x5cb4041(%rbp)
  40a023:	43 9a                	rex.XB (bad) 
  40a025:	bf bf bf bb 3a       	mov    $0x3abbbfbf,%edi
  40a02a:	7f ca                	jg     409ff6 <_fini+0xc02>
  40a02c:	b5 07                	mov    $0x7,%ch
  40a02e:	bf bf bf bf 56       	mov    $0x56bfbfbf,%edi
  40a033:	ce                   	(bad)  
  40a034:	bd bf bf 34 fa       	mov    $0xfa34bfbf,%ebp
  40a039:	43 9a                	rex.XB (bad) 
  40a03b:	bf bf 3f bf 3a       	mov    $0x3abf3fbf,%edi
  40a040:	7f cb                	jg     40a00d <puzzle_x86_64+0xd>
  40a042:	b5 07                	mov    $0x7,%ch
  40a044:	bf bf bf bf 56       	mov    $0x56bfbfbf,%edi
  40a049:	e4 bd                	in     $0xbd,%al
  40a04b:	bf bf 34 fa 43       	mov    $0x43fa34bf,%edi
  40a050:	9a                   	(bad)  
  40a051:	bf bf bd bf 3a       	mov    $0x3abfbdbf,%edi
  40a056:	7f ca                	jg     40a022 <puzzle_x86_64+0x22>
  40a058:	b5 07                	mov    $0x7,%ch
  40a05a:	bf bf bf bf 56       	mov    $0x56bfbfbf,%edi
  40a05f:	fa                   	cli    
  40a060:	bd bf bf 34 fa       	mov    $0xfa34bfbf,%ebp
  40a065:	43 9a                	rex.XB (bad) 
  40a067:	bf bf 9f bf 3a       	mov    $0x3abf9fbf,%edi
  40a06c:	7f cb                	jg     40a039 <puzzle_x86_64+0x39>
  40a06e:	b5 07                	mov    $0x7,%ch
  40a070:	bf bf bf bf 56       	mov    $0x56bfbfbf,%edi
  40a075:	90                   	nop
  40a076:	bd bf bf 34 fa       	mov    $0xfa34bfbf,%ebp
  40a07b:	43 3c 5f             	rex.XB cmp $0x5f,%al
  40a07e:	bb 3a 7f cb b5       	mov    $0xb5cb7f3a,%ebx
  40a083:	07                   	(bad)  
  40a084:	bf bf bf bf 56       	mov    $0x56bfbfbf,%edi
  40a089:	a4                   	movsb  %ds:(%rsi),%es:(%rdi)
  40a08a:	bd bf bf 34 fa       	mov    $0xfa34bfbf,%ebp
  40a08f:	43 9a                	rex.XB (bad) 
  40a091:	bf bf bf bd 3a       	mov    $0x3abdbfbf,%edi
  40a096:	7f ca                	jg     40a062 <puzzle_x86_64+0x62>
  40a098:	b5 07                	mov    $0x7,%ch
  40a09a:	bf bf bf bf 56       	mov    $0x56bfbfbf,%edi
  40a09f:	ba bd bf bf 34       	mov    $0x34bfbfbd,%edx
  40a0a4:	fa                   	cli    
  40a0a5:	43 9a                	rex.XB (bad) 
  40a0a7:	bf be bf bf 3a       	mov    $0x3abfbfbe,%edi
  40a0ac:	7f cb                	jg     40a079 <puzzle_x86_64+0x79>
  40a0ae:	b5 07                	mov    $0x7,%ch
  40a0b0:	bf bf bf bf 56       	mov    $0x56bfbfbf,%edi
  40a0b5:	50                   	push   %rax
  40a0b6:	be bf bf 34 fa       	mov    $0xfa34bfbf,%esi
  40a0bb:	43 9a                	rex.XB (bad) 
  40a0bd:	bf bf af bf 3a       	mov    $0x3abfafbf,%edi
  40a0c2:	7f cb                	jg     40a08f <puzzle_x86_64+0x8f>
  40a0c4:	b5 07                	mov    $0x7,%ch
  40a0c6:	bf bf bf bf 56       	mov    $0x56bfbfbf,%edi
  40a0cb:	66 be bf bf          	mov    $0xbfbf,%si
  40a0cf:	34 fa                	xor    $0xfa,%al
  40a0d1:	43 9a                	rex.XB (bad) 
  40a0d3:	bf bb bf bf 3a       	mov    $0x3abfbfbb,%edi
  40a0d8:	7f cb                	jg     40a0a5 <puzzle_x86_64+0xa5>
  40a0da:	b5 07                	mov    $0x7,%ch
  40a0dc:	bf bf bf bf 56       	mov    $0x56bfbfbf,%edi
  40a0e1:	7c be                	jl     40a0a1 <puzzle_x86_64+0xa1>
  40a0e3:	bf bf 34 fa 43       	mov    $0x43fa34bf,%edi
  40a0e8:	9a                   	(bad)  
  40a0e9:	3f                   	(bad)  
  40a0ea:	bf bf bf 3a 7f       	mov    $0x7f3abfbf,%edi
  40a0ef:	ca b5 07             	lret   $0x7b5
  40a0f2:	bf bf bf bf 56       	mov    $0x56bfbfbf,%edi
  40a0f7:	12 be bf bf 34 fa    	adc    -0x5cb4041(%rsi),%bh
  40a0fd:	43 9a                	rex.XB (bad) 
  40a0ff:	bf bf b7 bf 3a       	mov    $0x3abfb7bf,%edi
  40a104:	7f ca                	jg     40a0d0 <puzzle_x86_64+0xd0>
  40a106:	b5 07                	mov    $0x7,%ch
  40a108:	bf bf bf bf 56       	mov    $0x56bfbfbf,%edi
  40a10d:	28 be bf bf 34 fa    	sub    %bh,-0x5cb4041(%rsi)
  40a113:	43 9a                	rex.XB (bad) 
  40a115:	bf bf bf ff 3a       	mov    $0x3affbfbf,%edi
  40a11a:	7f ca                	jg     40a0e6 <puzzle_x86_64+0xe6>
  40a11c:	b5 07                	mov    $0x7,%ch
  40a11e:	bf bf bf bf 56       	mov    $0x56bfbfbf,%edi
  40a123:	3e be bf bf 34 fa    	ds mov $0xfa34bfbf,%esi
  40a129:	43 9a                	rex.XB (bad) 
  40a12b:	bf bf ff bf 3a       	mov    $0x3abfffbf,%edi
  40a130:	7f cb                	jg     40a0fd <puzzle_x86_64+0xfd>
  40a132:	b5 07                	mov    $0x7,%ch
  40a134:	bf bf bf bf 56       	mov    $0x56bfbfbf,%edi
  40a139:	d4                   	(bad)  
  40a13a:	be bf bf 34 fa       	mov    $0xfa34bfbf,%esi
  40a13f:	43 3c 5f             	rex.XB cmp $0x5f,%al
  40a142:	9f                   	lahf   
  40a143:	3a 7f ca             	cmp    -0x36(%rdi),%bh
  40a146:	b5 07                	mov    $0x7,%ch
  40a148:	bf bf bf bf 56       	mov    $0x56bfbfbf,%edi
  40a14d:	e8 be bf bf 34       	call   35006110 <_end+0x34bf9060>
  40a152:	fa                   	cli    
  40a153:	43 9a                	rex.XB (bad) 
  40a155:	bf bf bf af 3a       	mov    $0x3aafbfbf,%edi
  40a15a:	7f ca                	jg     40a126 <puzzle_x86_64+0x126>
  40a15c:	b5 07                	mov    $0x7,%ch
  40a15e:	bf bf bf bf 56       	mov    $0x56bfbfbf,%edi
  40a163:	fe                   	(bad)  
  40a164:	be bf bf 34 fa       	mov    $0xfa34bfbf,%esi
  40a169:	43 9a                	rex.XB (bad) 
  40a16b:	bf bf bf 9f 3a       	mov    $0x3a9fbfbf,%edi
  40a170:	7f cb                	jg     40a13d <puzzle_x86_64+0x13d>
  40a172:	b5 07                	mov    $0x7,%ch
  40a174:	bf bf bf bf 56       	mov    $0x56bfbfbf,%edi
  40a179:	94                   	xchg   %eax,%esp
  40a17a:	be bf bf 34 fa       	mov    $0xfa34bfbf,%esi
  40a17f:	43 3c 5f             	rex.XB cmp $0x5f,%al
  40a182:	af                   	scas   %es:(%rdi),%eax
  40a183:	3a 7f cb             	cmp    -0x35(%rdi),%bh
  40a186:	b5 07                	mov    $0x7,%ch
  40a188:	bf bf bf bf 56       	mov    $0x56bfbfbf,%edi
  40a18d:	a8 be                	test   $0xbe,%al
  40a18f:	bf bf 34 fa 43       	mov    $0x43fa34bf,%edi
  40a194:	9a                   	(bad)  
  40a195:	bf bf bb bf 3a       	mov    $0x3abfbbbf,%edi
  40a19a:	7f ca                	jg     40a166 <puzzle_x86_64+0x166>
  40a19c:	b5 07                	mov    $0x7,%ch
  40a19e:	bf bf bf bf 56       	mov    $0x56bfbfbf,%edi
  40a1a3:	be be bf bf 34       	mov    $0x34bfbfbe,%esi
  40a1a8:	fa                   	cli    
  40a1a9:	43 9a                	rex.XB (bad) 
  40a1ab:	bf bf be bf 3a       	mov    $0x3abfbebf,%edi
  40a1b0:	7f ca                	jg     40a17c <puzzle_x86_64+0x17c>
  40a1b2:	b5 07                	mov    $0x7,%ch
  40a1b4:	bf bf bf bf 56       	mov    $0x56bfbfbf,%edi
  40a1b9:	54                   	push   %rsp
  40a1ba:	bf bf bf 34 fa       	mov    $0xfa34bfbf,%edi
  40a1bf:	43 9a                	rex.XB (bad) 
  40a1c1:	bf af bf bf 3a       	mov    $0x3abfbfaf,%edi
  40a1c6:	7f cb                	jg     40a193 <puzzle_x86_64+0x193>
  40a1c8:	b5 07                	mov    $0x7,%ch
  40a1ca:	bf bf bf bf 56       	mov    $0x56bfbfbf,%edi
  40a1cf:	6a bf                	push   $0xffffffffffffffbf
  40a1d1:	bf bf 34 fa 43       	mov    $0x43fa34bf,%edi
  40a1d6:	9a                   	(bad)  
  40a1d7:	bf bd bf bf 3a       	mov    $0x3abfbfbd,%edi
  40a1dc:	7f cb                	jg     40a1a9 <puzzle_x86_64+0x1a9>
  40a1de:	b5 07                	mov    $0x7,%ch
  40a1e0:	bf bf bf bf 56       	mov    $0x56bfbfbf,%edi
  40a1e5:	00 bf bf bf 34 fa    	add    %bh,-0x5cb4041(%rdi)
  40a1eb:	43 3c 5f             	rex.XB cmp $0x5f,%al
  40a1ee:	ff                   	(bad)  
  40a1ef:	3a 7f cb             	cmp    -0x35(%rdi),%bh
  40a1f2:	b5 07                	mov    $0x7,%ch
  40a1f4:	bf bf bf bf 56       	mov    $0x56bfbfbf,%edi
  40a1f9:	14 bf                	adc    $0xbf,%al
  40a1fb:	bf bf 34 fa 43       	mov    $0x43fa34bf,%edi
  40a200:	3a 7f c7             	cmp    -0x39(%rdi),%bh
  40a203:	b5 07                	mov    $0x7,%ch
  40a205:	bf bf bf bf 56       	mov    $0x56bfbfbf,%edi
  40a20a:	25 bf bf bf 34       	and    $0x34bfbfbf,%eax
  40a20f:	fa                   	cli    
  40a210:	43 9a                	rex.XB (bad) 
  40a212:	bf bf bf b7 3a       	mov    $0x3ab7bfbf,%edi
  40a217:	7f ca                	jg     40a1e3 <puzzle_x86_64+0x1e3>
  40a219:	b5 07                	mov    $0x7,%ch
  40a21b:	bf bf bf bf 56       	mov    $0x56bfbfbf,%edi
  40a220:	3b bf bf bf 34 fa    	cmp    -0x5cb4041(%rdi),%edi
  40a226:	43 9a                	rex.XB (bad) 
  40a228:	bf 9f bf bf 3a       	mov    $0x3abfbf9f,%edi
  40a22d:	7f cb                	jg     40a1fa <puzzle_x86_64+0x1fa>
  40a22f:	b8 07 bf bf bf       	mov    $0xbfbfbf07,%eax
  40a234:	bf 54 ce 34 fa       	mov    $0xfa34ce54,%edi
  40a239:	43 3c 5f             	rex.XB cmp $0x5f,%al
  40a23c:	b7 3a                	mov    $0x3a,%bh
  40a23e:	7f cb                	jg     40a20b <puzzle_x86_64+0x20b>
  40a240:	b8 07 bf bf bf       	mov    $0xbfbfbf07,%eax
  40a245:	bf 54 df 34 fa       	mov    $0xfa34df54,%edi
  40a24a:	43 9a                	rex.XB (bad) 
  40a24c:	bf 3f bf bf 3a       	mov    $0x3abfbf3f,%edi
  40a251:	7f cb                	jg     40a21e <puzzle_x86_64+0x21e>
  40a253:	b8 07 bf bf bf       	mov    $0xbfbfbf07,%eax
  40a258:	bf 54 f2 34 fa       	mov    $0xfa34f254,%edi
  40a25d:	43 3c 5f             	rex.XB cmp $0x5f,%al
  40a260:	bd 3a 7f ca b8       	mov    $0xb8ca7f3a,%ebp
  40a265:	07                   	(bad)  
  40a266:	bf bf bf bf 54       	mov    $0x54bfbfbf,%edi
  40a26b:	83 34 fa 43          	xorl   $0x43,(%rdx,%rdi,8)
  40a26f:	9a                   	(bad)  
  40a270:	bf bf bf be 3a       	mov    $0x3abebfbf,%edi
  40a275:	7f ca                	jg     40a241 <puzzle_x86_64+0x241>
  40a277:	b8 07 bf bf bf       	mov    $0xbfbfbf07,%eax
  40a27c:	bf 54 96 34 fa       	mov    $0xfa349654,%edi
  40a281:	43 3c 5f             	rex.XB cmp $0x5f,%al
  40a284:	be 3a 7f cb b8       	mov    $0xb8cb7f3a,%esi
  40a289:	07                   	(bad)  
  40a28a:	bf bf bf bf 54       	mov    $0x54bfbfbf,%edi
  40a28f:	a7                   	cmpsl  %es:(%rdi),%ds:(%rsi)
  40a290:	34 fa                	xor    $0xfa,%al
  40a292:	43 9a                	rex.XB (bad) 
  40a294:	bf ff bf bf 3a       	mov    $0x3abfbfff,%edi
  40a299:	7f ca                	jg     40a265 <puzzle_x86_64+0x265>
  40a29b:	b8 07 bf bf bf       	mov    $0xbfbfbf07,%eax
  40a2a0:	bf 54 ba 07 be       	mov    $0xbe07ba54,%edi
  40a2a5:	bf bf bf e2 7c       	mov    $0x7ce2bfbf,%edi
  40a2aa:	48 69 20 42 65 6e 6e 	imul   $0x6e6e6542,(%rax),%rsp
...
000000000040a2d4 <cookie>:
  40a2d4:	70 dc                	jo     40a2b2 <puzzle_x86_64+0x2b2>
  40a2d6:	95                   	xchg   %eax,%ebp
  40a2d7:	2b 2f                	sub    (%rdi),%ebp
