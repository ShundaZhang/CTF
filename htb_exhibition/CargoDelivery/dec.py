...
def bitflip(buf,index,padding,c1,io):
	for i in range(256):
		...
		io.sendline('2')
		io.recvuntil('Enter your  ciphertext:')
		io.sendline(x)
		rbuf = io.recvuntil('2. Send your encrypted message.')
...
io.recvuntil('2. Send your encrypted message.')

io.sendline('1')

buf = io.recvuntil('2. Send your encrypted message.')
buf = buf.split('\n')[1]
