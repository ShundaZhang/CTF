       ...
       PROCEDURE DIVISION.
          ...
          PERFORM VM WITH TEST AFTER UNTIL PS EQUALS 1
             IF T IS ZERO
       	 THEN PERFORM DECODE
       	 ELSE DISPLAY "WRONG" END-DISPLAY
             END-IF
          STOP RUN.
       ...
       CONV.
          MOVE 5 TO RI
          PERFORM 10 TIMES
             COMPUTE R1 = FUNCTION MOD (R0(RI:2) 40) + 1
             MOVE RCS(R1:1) TO RC
       ...
       DECODE.
          MOVE 1 TO FI
          MOVE PWK TO R0(5:20)
          COMPUTE R0 = FUNCTION MOD (((519*R0) - 9524936758751936028873) 18446744073709551557)
          PERFORM CONV
          MOVE PWK TO R0(5:20)
          COMPUTE R0 = FUNCTION MOD (((655*R0) - 5139944510939323535175) 18446744073709551557)
          PERFORM CONV
          MOVE PWK TO R0(5:20)
          COMPUTE R0 = FUNCTION MOD (((301*R0) - 5165552119864536862147) 18446744073709551557)
          END-COMPUTE
          PERFORM CONV
          DISPLAY FW.
       VM.
          ...
          PERFORM 11 TIMES
             ...
             COMPUTE RI = FUNCTION MOD ((RI - P0 - Q(1) + 1) 40)
             END-COMPUTE
             ADD 1 TO RI
