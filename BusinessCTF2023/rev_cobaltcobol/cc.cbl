       ...
       DECODE.
          MOVE 1 TO FI
          MOVE PWK TO R0(5:20)
         COMPUTE R0 = FUNCTION MOD (((519*R0) - 9524936758751936028873) 
              18446744073709551557)
          PERFORM CONV
          MOVE PWK TO R0(5:20)
         COMPUTE R0 = FUNCTION MOD (((655*R0) - 5139944510939323535175) 
              18446744073709551557)
          PERFORM CONV
          MOVE PWK TO R0(5:20)
         COMPUTE R0 = FUNCTION MOD (((301*R0) - 5165552119864536862147) 
              18446744073709551557)
          END-COMPUTE
          PERFORM CONV
          DISPLAY FW.
