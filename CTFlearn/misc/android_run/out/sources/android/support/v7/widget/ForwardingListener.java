...
public abstract class ForwardingListener implements View.OnTouchListener {
    ...
    private void addDetachListenerBase(View view) {
        view.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            boolean mIsAttached = FA9wpogw7T2cch1yvAhu.v2M5tDdWJhh6Ih9TdTGS(ForwardingListener.this.mSrc);

            public void onGlobalLayout() {
                boolean z = this.mIsAttached;
                this.mIsAttached = FA9wpogw7T2cch1yvAhu.v2M5tDdWJhh6Ih9TdTGS(ForwardingListener.this.mSrc);
    ...
    private boolean onTouchForwarded(MotionEvent motionEvent) {
        ...
        return onForwardedEvent && (wjan6g1aXIJQJJbfuT != 1 && wjan6g1aXIJQJJbfuT != 3);
    }
