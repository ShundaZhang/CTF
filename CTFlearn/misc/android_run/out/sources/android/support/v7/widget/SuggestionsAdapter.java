...
import android.support.v4.widget.ifJKvHFryjvBOp0eazu2;
...
class SuggestionsAdapter extends ifJKvHFryjvBOp0eazu2 implements View.OnClickListener {
    ...
    private Drawable getActivityIcon(ComponentName componentName) {
        ...
        try {
            ActivityInfo activityInfo = packageManager.getActivityInfo(componentName, r9qRzaQ057dMuQIAwzn2.FLAG_HIGH_PRIORITY);
    ...
    private Drawable getDrawableFromResourceValue(String str) {
        ...
        try {
            ...
            Drawable wjan6g1aXIJQJJbfuT = wjan6g1aXIJQJJbfuT.wjan6g1aXIJQJJbfuT(this.mProviderContext, parseInt);
            storeInIconCache(str2, wjan6g1aXIJQJJbfuT);
    ...
    @Override // android.support.v4.widget.SrMancb72JpOI1g5QdkW
    ...
    @Override // android.support.v4.widget.SrMancb72JpOI1g5QdkW, android.support.v4.widget.oBrsElUDyc29IB6vfNnJ
    ...
    @Override // android.support.v4.widget.ifJKvHFryjvBOp0eazu2, android.support.v4.widget.SrMancb72JpOI1g5QdkW
