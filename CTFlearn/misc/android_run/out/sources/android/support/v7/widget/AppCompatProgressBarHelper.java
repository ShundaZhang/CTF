...
public class AppCompatProgressBarHelper {
    ...
    private Drawable tileify(Drawable drawable, boolean z) {
        if (drawable instanceof SrMancb72JpOI1g5QdkW) {
            Drawable wjan6g1aXIJQJJbfuT = ((SrMancb72JpOI1g5QdkW) drawable).wjan6g1aXIJQJJbfuT();
            if (wjan6g1aXIJQJJbfuT == null) {
                return drawable;
            }
            ((SrMancb72JpOI1g5QdkW) drawable).wjan6g1aXIJQJJbfuT(tileify(wjan6g1aXIJQJJbfuT, z));
            return drawable;
