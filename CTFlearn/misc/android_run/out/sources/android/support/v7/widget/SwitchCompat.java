...
public class SwitchCompat extends CompoundButton {
    ...
    private void applyThumbTint() {
        ...
        if (this.mHasThumbTint || this.mHasThumbTintMode) {
            ...
            if (this.mHasThumbTint) {
                wjan6g1aXIJQJJbfuT.wjan6g1aXIJQJJbfuT(this.mThumbDrawable, this.mThumbTintList);
            }
            if (this.mHasThumbTintMode) {
                wjan6g1aXIJQJJbfuT.wjan6g1aXIJQJJbfuT(this.mThumbDrawable, this.mThumbTintMode);
            }
    ...
    private void applyTrackTint() {
        ...
        if (this.mHasTrackTint || this.mHasTrackTintMode) {
            ...
            if (this.mHasTrackTint) {
                wjan6g1aXIJQJJbfuT.wjan6g1aXIJQJJbfuT(this.mTrackDrawable, this.mTrackTintList);
            }
            if (this.mHasTrackTintMode) {
                wjan6g1aXIJQJJbfuT.wjan6g1aXIJQJJbfuT(this.mTrackDrawable, this.mTrackTintMode);
            }
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mThumbDrawable != null) {
            ...
            if (background != null) {
                wjan6g1aXIJQJJbfuT.wjan6g1aXIJQJJbfuT(background, i9, i5, i10, i7);
            }
        }
        super.draw(canvas);
    }
    ...
    public void drawableHotspotChanged(float f, float f2) {
        ...
        if (this.mThumbDrawable != null) {
            wjan6g1aXIJQJJbfuT.wjan6g1aXIJQJJbfuT(this.mThumbDrawable, f, f2);
        }
        if (this.mTrackDrawable != null) {
            wjan6g1aXIJQJJbfuT.wjan6g1aXIJQJJbfuT(this.mTrackDrawable, f, f2);
        }
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (getMeasuredHeight() < max2) {
            setMeasuredDimension(FA9wpogw7T2cch1yvAhu.lkxWRuhVrcpxMTIj0xg(this), max2);
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        switch (ubT4q125yeOcOGN5JfxT.wjan6g1aXIJQJJbfuT(motionEvent)) {
            case 0:
    ...
    public void setChecked(boolean z) {
        super.setChecked(z);
        boolean isChecked = isChecked();
        if (getWindowToken() == null || !FA9wpogw7T2cch1yvAhu.NZSjriCiBCmHW5rfoI(this) || !isShown()) {
            cancelPositionAnimator();
            setThumbPosition(isChecked ? 1.0f : 0.0f);
            return;
        }
