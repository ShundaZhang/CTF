...
public class TwilightManager {
    ...
    private Location getLastKnownLocation() {
        ...
        Location lastKnownLocationForProvider = BsdFKBmxbpWmGnzYUKFl.wjan6g1aXIJQJJbfuT(this.mContext, "android.permission.ACCESS_COARSE_LOCATION") == 0 ? getLastKnownLocationForProvider("network") : null;
        if (BsdFKBmxbpWmGnzYUKFl.wjan6g1aXIJQJJbfuT(this.mContext, "android.permission.ACCESS_FINE_LOCATION") == 0) {
