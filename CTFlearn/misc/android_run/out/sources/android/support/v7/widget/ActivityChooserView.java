...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    ubT4q125yeOcOGN5JfxT mProvider$3c48b171;
            ...
            switch (getItemViewType(i)) {
                case 0:
                    ...
                    if (!this.mShowDefaultActivity || i != 0 || !this.mHighlightDefaultActivity) {
                        FA9wpogw7T2cch1yvAhu.zI5xFkVDsajIQcz4DH2(view, false);
                        return view;
                    }
                    FA9wpogw7T2cch1yvAhu.zI5xFkVDsajIQcz4DH2(view, true);
                    return view;
                case 1:
    ...
    public class Callbacks implements View.OnClickListener, View.OnLongClickListener, AdapterView.OnItemClickListener, PopupWindow.OnDismissListener {
        ...
        public void onDismiss() {
            ...
            if (ActivityChooserView.this.mProvider$3c48b171 != null) {
                ActivityChooserView.this.mProvider$3c48b171.subUiVisibilityChanged(false);
            }
        }
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mOnGlobalLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                if (ActivityChooserView.this.mProvider$3c48b171 != null) {
                    ActivityChooserView.this.mProvider$3c48b171.subUiVisibilityChanged(true);
                }
            }
        };
    ...
    public void setProvider$7aa8c5bc(ubT4q125yeOcOGN5JfxT ubt4q125yeocogn5jfxt) {
        this.mProvider$3c48b171 = ubt4q125yeocogn5jfxt;
    }
    ...
    public void showPopupUnchecked(int i) {
        ...
        if (!listPopupWindow.isShowing()) {
            ...
            if (this.mProvider$3c48b171 != null) {
                this.mProvider$3c48b171.subUiVisibilityChanged(true);
            }
