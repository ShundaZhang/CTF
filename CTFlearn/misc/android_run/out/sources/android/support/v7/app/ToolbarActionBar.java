...
public class ToolbarActionBar extends ActionBar {
    ...
    public float getElevation() {
        return FA9wpogw7T2cch1yvAhu.AwHRhcGSsWDVBqmZnF6L(this.mDecorToolbar.getViewGroup());
    }
    ...
    public boolean invalidateOptionsMenu() {
        ...
        FA9wpogw7T2cch1yvAhu.wjan6g1aXIJQJJbfuT(this.mDecorToolbar.getViewGroup(), this.mMenuInvalidator);
        return true;
    }
    ...
    public void setElevation(float f) {
        FA9wpogw7T2cch1yvAhu.BsdFKBmxbpWmGnzYUKFl(this.mDecorToolbar.getViewGroup(), f);
    }
