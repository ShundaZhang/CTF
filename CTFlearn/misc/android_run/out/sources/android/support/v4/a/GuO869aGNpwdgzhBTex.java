...
public final class GuO869aGNpwdgzhBTex implements Runnable {
    private /* synthetic */ ArrayList wjan6g1aXIJQJJbfuT;
    private /* synthetic */ Map zI5xFkVDsajIQcz4DH2;

    GuO869aGNpwdgzhBTex(ArrayList arrayList, Map map) {
    ...
    public final void run() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            view.setTransitionName((String) this.zI5xFkVDsajIQcz4DH2.get(view.getTransitionName()));
        }
    }
}
