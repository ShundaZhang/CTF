0804848f <jump>:
 ...
 8048495:       c7 45 f0 00 00 00 00    movl   $0x0,-0x10(%ebp)		;0 -> epb-10
 804849c:       83 ec 0c                sub    $0xc,%esp
 804849f:       68 70 85 04 08          push   $0x8048570
 80484a4:       e8 87 fe ff ff          call   8048330 <printf@plt>	;printf
 ...
 80484ba:       50                      push   %eax
 80484bb:       e8 80 fe ff ff          call   8048340 <fgets@plt>	;fgets epb-10, 4, 'jump' ;fgets will add '\0' for 'jump' !!!
 80484c0:       83 c4 10                add    $0x10,%esp               ;so 'jump' is trucated to 'jum' !!!
 80484c3:       c7 45 f4 00 00 00 00    movl   $0x0,-0xc(%ebp)          ;after load from memroy to eax, it will be '\x00muj'
 80484ca:       eb 0d                   jmp    80484d9 <jump+0x4a>
 80484cc:       8b 45 f0                mov    -0x10(%ebp),%eax
 80484cf:       83 c0 05                add    $0x5,%eax
 80484d2:       89 45 f0                mov    %eax,-0x10(%ebp)		;[ebp-10] +5 -> +40
 80484d5:       83 45 f4 01             addl   $0x1,-0xc(%ebp)
 80484d9:       83 7d f4 07             cmpl   $0x7,-0xc(%ebp)		;0 <= 7, 8 times
 80484dd:       7e ed                   jle    80484cc <jump+0x3d>
 80484df:       8b 45 f0                mov    -0x10(%ebp),%eax 	;epb-10
