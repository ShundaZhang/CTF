...
_sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_32631 = Integer(32631); _sage_const_16 = Integer(16); _sage_const_2 = Integer(2); _sage_const_256 = Integer(256)#https://chovid99.github.io/posts/cyber-apocalypse-2023-crypto/#biased-heritage
...
ip, port = '165.232.100.46', _sage_const_32631 
io = remote(ip, port)
