...
# This file was *autogenerated* from the file coppersmith_ubuntor.sage
from sage.all_cmdline import *   # import sage library

_sage_const_2 = Integer(2); _sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_512 = Integer(512); _sage_const_300 = Integer(300)
...
def main():
    ...
    nbits = _sage_const_512  # bitlength of primes
    p = random_prime(_sage_const_2 **nbits-_sage_const_1 , proof=False, lbound=_sage_const_2 **(nbits-_sage_const_1 ))
    q = random_prime(_sage_const_2 **nbits-_sage_const_1 , proof=False, lbound=_sage_const_2 **(nbits-_sage_const_1 ))
    n = p*q

    lbits = _sage_const_300  # number of lower bits of p
    ln = _sage_const_2 **lbits
    p0 = p % ln
    ...
    assert q0 == q % ln
    X = Y = _sage_const_2 **(nbits+_sage_const_1 -lbits) # bounds on x0 and y0

    P = PolynomialRing(ZZ, names=('x', 'y',)); (x, y,) = P._first_ngens(2)
    pol = (ln*x+p0)*(ln*y+q0) - n # Should have a root at (x0,y0)

    x0_2, y0_2 = coron(pol, X, Y, k=_sage_const_2 , debug=True)[_sage_const_0 ]
    p_2 = x0_2*ln + p0
    q_2 = y0_2*ln + q0
    ...
    lbits = (_sage_const_512 -_sage_const_300 ) # number of masked bits of p
    ln = _sage_const_2 **lbits
    p0 = p // ln
    ...
    # Recovery starts here
    q0 = floor(n / (p0*ln))//ln
    X = Y = _sage_const_2 **(lbits+_sage_const_2 ) # bounds on x0 and y0
    P = PolynomialRing(ZZ, names=('x', 'y',)); (x, y,) = P._first_ngens(2)
